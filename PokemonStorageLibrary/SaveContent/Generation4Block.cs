...
{
    public static readonly int[] SeedTable =
    [
    ...
    public Generation4Block(byte[] content, Game game, bool isSmall, bool isBackup = false)
    {
        IsSmall = isSmall;
        IsBackup = isBackup;
        int thisBlockOffset = isBackup ? BACKUP_OFFSET : 0;
        if (isSmall)
        {
            switch (game.VersionGroupId)
            {
                case 8: // Diamond/Pearl
                    DataOffset = thisBlockOffset+0x0;
                    DataLength = 0xC0EC;
                    FooterOffset = thisBlockOffset+0xC0EC;
                    FooterLength = 0x14;
                    break;
                case 9: // Platinum
                    DataOffset = thisBlockOffset+0x0;
                    DataLength = 0xCF18;
                    FooterOffset = thisBlockOffset+0xCF18;
                    FooterLength = 0x14;
                    break;
                case 10: // HGSS
                    DataOffset = thisBlockOffset+0x0;
                    DataLength = 0xF618;
                    FooterOffset = thisBlockOffset+0xF618;
                    FooterLength = 0x10;
                    break;
            }            
        }
        else
        {
            ...
            {
                case 8: // Diamond/Pearl
                    DataOffset = thisBlockOffset+0x0C100;
                ...
                case 9: // Platinum
                    ...
                    break;
                case 10: // HGSS
                    DataOffset = thisBlockOffset+0x0F700;
                    FooterOffset = thisBlockOffset+0x21A00;
                    DataLength = FooterOffset-DataOffset;
                    FooterLength = 0x10;
                    break;
            }    
        }
        Data = Utility.GetBytes(content, DataOffset, DataLength);
        Footer = Utility.GetBytes(content, FooterOffset, FooterLength);
    }
